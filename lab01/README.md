...
```
Конфигурационные файлы коммутаторов [S1](../lab01/configs/S1) и [S2](../lab01/configs/S2) и пример конфигурации основных портов: <br/>
S1
```
!
...
```
Конфигурационный файл маршрутизатора [R1](../lab01/configs/R1) и пример конфигураци порта G0/0/1 и его подынтерфейсов:
```
!
